...
async function main() {
  ...
  const sampleInteractions = [
    { contentId: createdContents[0].id, type: InteractionType.LIKE },
    { contentId: createdContents[1].id, type: InteractionType.COMPLETE },
    { contentId: createdContents[2].id, type: InteractionType.LIKE },
    { contentId: createdContents[3].id, type: InteractionType.VIEW },
    { contentId: createdContents[4].id, type: InteractionType.LIKE },
  ];
